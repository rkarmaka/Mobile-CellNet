...
########################################################################################################################
model_res_unet=models.mobile_cellNet(image_size=img_size)
...
log_dir = 'new_test_set/logs_patches/mobile_cellNet_roi' + datetime.now().strftime('%Y%m%d-%H%M%S')
...
history_res_unet_df.to_csv('new_test_set/results_patches/model_mobile_cellNet_roi.csv')
